...
func newPost(db *gorm.DB, opts ...gen.DOOption) post {
	...
	_post.Tag = field.NewString(tableName, "tag")
	_post.TopicsName = field.NewString(tableName, "topics_name")
	_post.MdPlainText = field.NewString(tableName, "md_plain_text")
...
type post struct {
	...
	UserID      field.Int32
	Tag         field.String
	TopicsName  field.String
	MdPlainText field.String
...
func (p *post) updateTableName(table string) *post {
	...
	p.TopicsName = field.NewString(table, "topics_name")
	p.MdPlainText = field.NewString(table, "md_plain_text")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["topics_name"] = p.TopicsName
	p.fieldMap["md_plain_text"] = p.MdPlainText
